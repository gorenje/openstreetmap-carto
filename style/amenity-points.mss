...
#amenity-points {
  ...
  [feature = 'amenity_atm'][zoom >= 25] {
    marker-file: url('symbols/amenity/atm.svg');
    marker-fill: @amenity-brown;
    marker-clip: false;
  }

  [feature = 'amenity_bureau_de_change'][zoom >= 25] {
    marker-file: url('symbols/amenity/bureau_de_change.svg');
    marker-fill: @amenity-brown;
    marker-clip: false;
  }

  [feature = 'amenity_bank'][zoom >= 25] {
    marker-file: url('symbols/amenity/bank.svg');
    marker-fill: @public-service;
    marker-clip: false;
  }

  [feature = 'amenity_bar'][zoom >= 25],
  [feature = 'amenity_biergarten'][zoom >= 25],
  [feature = 'amenity_cafe'][zoom >= 25],
  [feature = 'amenity_fast_food'][zoom >= 25],
  [feature = 'amenity_food_court'][zoom >= 25],
  [feature = 'amenity_ice_cream'][zoom >= 25],
  [feature = 'amenity_pub'][zoom >= 25],
  [feature = 'amenity_restaurant'][zoom >= 25] {
    marker-clip: false;
  ...
  [feature = 'amenity_internet_cafe'][zoom >= 25] {
    marker-file: url('symbols/amenity/internet_cafe.svg');
    marker-fill: @amenity-brown;
    marker-clip: false;
  }

  [feature = 'amenity_bbq'][zoom >= 25] {
  ...
  [feature = 'amenity_public_bookcase'][zoom >= 25] {
    marker-file: url('symbols/amenity/public_bookcase.svg');
    marker-fill: @amenity-brown;
    marker-clip: false;
  }

  [feature = 'amenity_bicycle_rental'][zoom >= 25] {
  ...
  [feature = 'highway_elevator'][zoom >= 25] {
    [access = null],
    [access = 'yes'] {
  ...
  [feature = 'highway_traffic_signals'][zoom >= 25] {
    marker-file: url('symbols/highway/traffic_light.13.svg');
    marker-fill: #545454;
    marker-clip: false;
  }

  [feature = 'barrier_toll_booth'][zoom >= 25] {
    marker-file: url('symbols/barrier/toll_booth.svg');
    marker-fill: @transportation-icon;
    marker-clip: false;
  }

  [feature = 'tourism_artwork'][zoom >= 25] {
    [artwork_type != 'statue'] {
  ...
  [feature = 'tourism_camp_site'][zoom >= 25] {
  ...
  [feature = 'amenity_charging_station'][zoom >= 25] {
  ...
  [feature = 'amenity_fuel'][zoom >= 25] {
    marker-file: url('symbols/amenity/fuel.svg');
    marker-fill: @transportation-icon;
    marker-clip: false;
  }

  [feature = 'tourism_guest_house'][zoom >= 25] {
    marker-file: url('symbols/tourism/guest_house.svg');
    marker-fill: @accommodation-icon;
    marker-clip: false;
  }

  [feature = 'tourism_apartment'][zoom >= 25] {
    marker-file: url('symbols/tourism/apartment.svg');
    marker-fill: @accommodation-icon;
    marker-clip: false;
  }

  [feature = 'amenity_bicycle_repair_station'][zoom >= 25] {
  ...
  [feature = 'amenity_casino'][zoom >= 25] {
    marker-file: url('symbols/amenity/casino.svg');
    marker-fill: @amenity-brown;
    marker-clip: false;
  }

  [feature = 'tourism_gallery'][zoom >= 25] {
    marker-file: url('symbols/shop/art.svg');
    marker-clip: false;
    marker-fill: @amenity-brown;
  }

  [feature = 'tourism_hostel'][zoom >= 25] {
    marker-file: url('symbols/tourism/hostel.svg');
    marker-clip: false;
    marker-fill: @accommodation-icon;
  }

  [feature = 'tourism_hotel'][zoom >= 25] {
    marker-file: url('symbols/tourism/hotel.svg');
    marker-clip: false;
    marker-fill: @accommodation-icon;
  }

  [feature = 'tourism_motel'][zoom >= 25] {
    marker-file: url('symbols/tourism/motel.svg');
    marker-clip: false;
    marker-fill: @accommodation-icon;
  }

  [feature = 'tourism_information'][zoom >= 25],
  [feature = 'tourism_information']["information"='office'][zoom >= 25] {
  ...
  [feature = 'amenity_social_facility'][zoom >= 25] {
    marker-file: url('symbols/amenity/social_facility.svg');
    marker-fill: @public-service;
    marker-clip: false;
  }

  [feature = 'amenity_townhall'][zoom >= 25] {
  ...
  [feature = 'man_made_mast']["tower:type" = 'lighting'][zoom >= 25]   {
    [zoom >= 25][height >= 160],
    [zoom >= 25][height >= 80],
    [zoom >= 25][height >= 40],
    [zoom >= 25][height >= 20],
  ...
  [feature = 'man_made_tower']["tower:type" = 'cooling'][zoom >= 25],
  [feature = 'man_made_tower']["tower:type" = 'lighting'][zoom >= 25],
  [feature = 'man_made_tower']["tower:type" = 'bell_tower'][zoom >= 25],
  [feature = 'man_made_tower']["tower:type" = 'watchtower'][zoom >= 25],
  ...
  [feature = 'man_made_communications_tower'][zoom >= 25] {
  ...
  [feature = 'man_made_telescope']["telescope:type" != 'optical']["telescope:type" != null] {
    [zoom >= 25]["telescope:diameter" >= 60],
    [zoom >= 25]["telescope:diameter" >= 30],
    [zoom >= 25] {
  ...
  [feature = 'man_made_telescope']["telescope:type" = null], {
    [zoom >= 25]["telescope:diameter" >= 8],
    [zoom >= 25]["telescope:diameter" >= 4],
    [zoom >= 25]["telescope:diameter" >= 2],
    [zoom >= 25] {
  ...
  [feature = 'historic_city_gate'][zoom >= 25] {
    marker-file: url('symbols/historic/city_gate.svg');
    marker-fill: @man-made-icon;
    marker-clip: false;
  }

  [feature = 'tourism_museum'][zoom >= 25] {
    marker-file: url('symbols/tourism/museum.svg');
    marker-fill: @culture;
    marker-clip: false;
  }

  [feature = 'amenity_clinic'][zoom >= 25],
  [feature = 'amenity_doctors'][zoom >= 25] {
    marker-file: url('symbols/amenity/doctors.svg');
    marker-fill: @health-color;
    marker-clip: false;
  }

  [feature = 'amenity_dentist'][zoom >= 25] {
    [zoom >= 25][zoom < 18] {
      marker-width: 4;
      marker-line-width: 0;
    }
  ...
  [feature = 'amenity_hospital'][zoom >= 25] {
    marker-file: url('symbols/amenity/hospital.svg');
    marker-fill: @health-color;
    marker-clip: false;
  }

  [feature = 'amenity_pharmacy'][zoom >= 25] {
    marker-file: url('symbols/amenity/pharmacy.svg');
    marker-fill: @health-color;
    marker-clip: false;
  }

  [feature = 'amenity_veterinary'][zoom >= 25] {
    marker-file: url('symbols/amenity/veterinary.svg');
    marker-fill: @health-color;
    marker-clip: false;
  }

  [feature = 'amenity_place_of_worship'][zoom >= 25] {
  ...
  [feature = 'man_made_storage_tank'][zoom >= 25],
  [feature = 'man_made_silo'][zoom >= 25] {
    marker-file: url('symbols/man_made/storage_tank.svg');
    marker-fill: @man-made-icon;
    marker-clip: false;
  }

  [feature = 'amenity_police'][zoom >= 25] {
    marker-file: url('symbols/amenity/police.svg');
    marker-fill: @public-service;
    marker-clip: false;
  }

  [feature = 'amenity_vehicle_inspection'][zoom >= 25] {
    marker-file: url('symbols/amenity/vehicle_inspection.svg');
    marker-fill: @public-service;
    marker-clip: false;
  }

  [feature = 'amenity_post_box'][zoom >= 25] {
    marker-file: url('symbols/amenity/post_box.svg');
    marker-fill: @amenity-brown;
    marker-clip: false;
  }

  [feature = 'amenity_post_office'][zoom >= 25] {
    marker-file: url('symbols/amenity/post_office.svg');
    marker-fill: @public-service;
    marker-clip: false;
  }

  [feature = 'amenity_recycling'][recycling_type = 'centre'][zoom >= 25],
  [feature = 'amenity_recycling'][zoom >= 25] {
  ...
  [feature = 'amenity_drinking_water'][zoom >= 25] {
  ...
  [feature = 'amenity_prison'][zoom >= 25] {
  ...
  [feature = 'amenity_driving_school'][zoom >= 25] {
    marker-width: 4;
    [zoom >= 25] {
      marker-width: 6;
    }
  ...
  [feature = 'tourism_viewpoint'][zoom >= 25] {
    marker-file: url('symbols/tourism/viewpoint.svg');
    marker-fill: @amenity-brown;
    marker-clip: false;
  }

  [feature = 'man_made_water_tower'][zoom >= 25] {
    marker-file: url('symbols/man_made/water_tower.svg');
    marker-fill: @man-made-icon;
    marker-clip: false;
  }

  [feature = 'historic_memorial'][memorial = null][zoom >= 25],
  [feature = 'historic_memorial'][memorial != null][memorial != 'blue_plaque'][memorial != 'bust'][memorial != 'plaque'][memorial != 'stele'][memorial != 'stone'][zoom >= 25],
  [feature = 'historic_memorial'][memorial = 'statue'][zoom >= 25],
  [feature = 'historic_memorial'][memorial = 'bust'][zoom >= 25],
  [feature = 'historic_memorial'][memorial = 'stele'][zoom >= 25],
  [feature = 'historic_memorial'][memorial = 'stone'][zoom >= 25],
  [feature = 'historic_memorial'][memorial = 'blue_plaque'][zoom >= 25],
  [feature = 'historic_memorial'][memorial = 'plaque'][zoom >= 25] {
  ...
  [feature = 'man_made_obelisk'][zoom >= 25] {
    marker-file: url('symbols/historic/obelisk.svg');
    marker-fill: @memorials;
    marker-clip: false;
  }

  [feature = 'historic_monument'][zoom >= 25] {
    marker-file: url('symbols/historic/monument.svg');
    marker-fill: @memorials;
    marker-clip: false;
  }

  [feature = 'historic_fort'][zoom >= 25] {
    marker-file: url('symbols/historic/fort.svg');
    marker-fill: @memorials;
    marker-clip: false;
  }

  [feature = 'historic_castle'][castle_type != 'stately'][castle_type != 'manor'][zoom >= 25],
  [feature = 'historic_castle'][castle_type = 'stately'][zoom >= 25],
  [feature = 'historic_castle'][castle_type = 'manor'][zoom >= 25],
  [feature = 'historic_manor'][zoom >= 25] {
  ...
  [feature = 'historic_archaeological_site'][zoom >= 25] {
    marker-file: url('symbols/historic/archaeological_site.svg');
    marker-fill: @culture;
    marker-clip: false;
  }

  [feature = 'amenity_marketplace'][zoom >= 25][way_pixels > 3000],
  [feature = 'amenity_marketplace'][zoom >= 25] {
    marker-clip: false;
    marker-fill: @shop-icon;
  ...
  [feature = 'shop'] {
    [shop != 'mall'][shop != 'massage'][zoom >= 25],
    [shop = 'supermarket'][zoom >= 25],
    [shop = 'department_store'][zoom >= 25] {
      marker-clip: false;
      marker-fill: @shop-icon;
    }

    [zoom >= 25][zoom < 18][shop != 'supermarket'][shop != 'department_store'][shop != 'mall'][shop != 'massage'] {
      marker-width: 4;
      marker-line-width: 0;
    }
    ...
    [shop = 'beverages'][zoom >= 25] {
      marker-file: url('symbols/shop/beverages.svg');
    }

    [shop = 'bookmaker'][zoom >= 25] {
    ...
    [shop = 'charity'][zoom >= 25] {
      marker-file: url('symbols/shop/charity.svg');
    }

    [shop = 'chemist'][zoom >= 25] {
    ...
    [shop = 'florist'][zoom >= 25] {
      marker-file: url('symbols/shop/florist.svg');
    }

    [shop = 'garden_centre'][zoom >= 25] {
    ...
    [shop = 'car_parts'][zoom >= 25] {
      marker-file: url('symbols/shop/car_parts.svg');
    }

    [shop = 'car_repair'][zoom >= 25] {
    ...
    [shop = 'musical_instrument'][zoom >= 25] {
    ...
    [shop = 'travel_agency'][zoom >= 25] {
      marker-file: url('symbols/shop/travel_agency.svg');
    }

    [shop = 'second_hand'][zoom >= 25] {
    ...
    [shop = 'stationery'][zoom >= 25] {
      marker-file: url('symbols/shop/stationery.svg');
    }

    [shop = 'tobacco'][zoom >= 25] {
    ...
    [shop = 'video_games'][zoom >= 25] {
      marker-file: url('symbols/shop/video_games.svg');
    }
  }

  [feature = 'advertising_column'][zoom >= 25]{
  ...
  [feature = 'diplomatic_embassy'][zoom >= 25] {
    marker-file: url('symbols/office/embassy.svg');
    marker-fill: @office;
    marker-clip: false;
  }

  [feature = 'diplomatic_consulate'][zoom >= 25] {
    marker-file: url('symbols/office/consulate.svg');
    marker-fill: @office;
    marker-clip: false;
  }

  [feature = 'leisure_water_park'][zoom >= 25],
  [feature = 'leisure_sports_centre'][sport = 'swimming'][zoom >= 25],
  [feature = 'leisure_swimming_area'][zoom >= 25] {
    marker-file: url('symbols/leisure/water_park.svg');
    marker-fill: @leisure-green;
    marker-clip: false;
  }

  [feature = 'leisure_fitness_centre'][zoom >= 25],
  [feature = 'leisure_fitness_station'][zoom >= 25] {
  ...
  [feature = 'leisure_dog_park'][zoom >= 25] {
    marker-file: url('symbols/shop/pet.svg');
    marker-fill: @leisure-green;
    marker-clip: false;
  }

  [feature = 'leisure_playground'][zoom >= 25] {
  ...
  [feature = 'leisure_miniature_golf'][zoom >= 25] {
    marker-file: url('symbols/leisure/miniature_golf.svg');
    marker-fill: @leisure-green;
    marker-clip: false;
  }

  [feature = 'leisure_golf_course'][zoom >= 25] {
    marker-file: url('symbols/leisure/golf.svg');
    marker-fill: @leisure-green;
    marker-clip: false;
  }

  [feature = 'tourism_picnic_site'][zoom >= 25] {
  ...
  [feature = 'leisure_picnic_table'][zoom >= 25] {
    marker-file: url('symbols/tourism/picnic.svg');
    marker-fill: @man-made-icon;
    marker-clip: false;
    [access != ''][access != 'permissive'][access != 'yes'] {
  ...
  [feature = 'leisure_firepit'][zoom >= 25] {
  ...
  [feature = 'leisure_slipway'][zoom >= 25] {
    marker-file: url('symbols/leisure/slipway.svg');
    marker-fill: @transportation-icon;
    marker-clip: false;
  }

  [feature = 'amenity_boat_rental'][zoom >= 25] {
    marker-file: url('symbols/amenity/boat_rental.svg');
    marker-fill: @transportation-icon;
    marker-clip: false;
  }

  [feature = 'aeroway_helipad'][zoom >= 25] {
    marker-file: url('symbols/helipad.16.svg');
    marker-clip: false;
    marker-fill: @airtransport;
  }

  [feature = 'aeroway_aerodrome']['access' != 'private']['icao' != null]['iata' != null][zoom >= 25][zoom < 17],
  [feature = 'aeroway_aerodrome']['access' = 'private'][zoom >= 25][zoom < 18],
  [feature = 'aeroway_aerodrome']['icao' = null][zoom >= 25][zoom < 18],
  [feature = 'aeroway_aerodrome']['iata' = null][zoom >= 25][zoom < 18] {
    [way_pixels <= 192000],
    [way_pixels = null] {
  ...
  [feature = 'amenity_ferry_terminal'][zoom >= 25] {
    marker-file: url('symbols/amenity/ferry.svg');
    marker-clip: false;
    marker-fill: @airtransport;
  }

  [feature = 'man_made_lighthouse'][zoom >= 25] {
    marker-file: url('symbols/man_made/lighthouse.svg');
    marker-clip: false;
    marker-fill: @man-made-icon;
  }

  [feature = 'natural_peak'][zoom >= 25] {
    marker-file: url('symbols/natural/peak.svg');
    marker-fill: @landform-color;
    marker-clip: false;
  }

  [feature = 'natural_volcano'][zoom >= 25] {
    marker-file: url('symbols/natural/peak.svg');
    marker-fill: #d40000;
    marker-clip: false;
  }

  [feature = 'natural_saddle'][zoom >= 25] {
    marker-file: url('symbols/natural/saddle.svg');
    marker-fill: @landform-color;
    marker-clip: false;
  }

  [feature = 'natural_spring'][zoom >= 25] {
    marker-file: url('symbols/spring.svg');
    marker-clip: false;
  }

  [feature = 'natural_cave_entrance'][zoom >= 25] {
  ...
  [feature = 'military_bunker'][zoom >= 25] {
  ...
  [feature = 'power_generator']['generator:source' = 'wind'] {
    [zoom >= 25][location != 'rooftop'][location != 'roof'],
    [zoom >= 25][location = null],
    [zoom >= 25] {
  ...
  [feature = 'man_made_windmill'][zoom >= 25] {
    marker-file: url('symbols/man_made/windmill.svg');
    marker-fill: @man-made-icon;
    marker-clip: false;
  }

  [feature = 'amenity_hunting_stand'][zoom >= 25] {
  ...
  [feature = 'amenity_waste_disposal'][zoom >= 25] {
    [access = null],
    [access = 'permissive'],
    [access = 'yes'] {
  ...
  [feature = 'amenity_parking_entrance'] {
    [zoom >= 25][way_pixels > 750],
    [zoom >= 25][feature = 'amenity_parking'],
    [zoom >= 25] {
...
#amenity-low-priority {
  [feature = 'man_made_cross'][zoom >= 25],
  [feature = 'historic_wayside_cross'][zoom >= 25] {
    marker-file: url('symbols/man_made/cross.svg');
    marker-fill: @religious-icon;
    marker-clip: false;
  }

  [feature = 'historic_wayside_shrine'][zoom >= 25] {
    marker-file: url('symbols/historic/shrine.svg');
    marker-fill: @man-made-icon;
    marker-clip: false;
  }

  [feature = 'railway_level_crossing'][zoom >= 25]::railway,
  [feature = 'railway_crossing'][zoom >= 25]::railway{
  ...
  [feature = 'barrier_lift_gate'][zoom >= 25]::barrier,
  [feature = 'barrier_swing_gate'][zoom >= 25]::barrier {
    marker-file: url('symbols/barrier/lift_gate.svg');
    marker-fill: @barrier-icon;
    marker-clip: false;
  }

  [feature = 'barrier_cattle_grid'][zoom >= 25]::barrier {
    marker-file: url('symbols/barrier/cattle_grid.svg');
    marker-fill: @barrier-icon;
    marker-clip: false;
  }

  [feature = 'barrier_stile'][zoom >= 25]::barrier {
    marker-file: url('symbols/barrier/stile.svg');
    marker-fill: @barrier-icon;
    marker-clip: false;
  }

  [feature = 'barrier_motorcycle_barrier'][zoom >= 25]::barrier {
    marker-file: url('symbols/barrier/motorcycle_barrier.svg');
    marker-fill: @barrier-icon;
    marker-clip: false;
  }

  [feature = 'barrier_cycle_barrier'][zoom >= 25]::barrier {
    marker-file: url('symbols/barrier/cycle_barrier.svg');
    marker-fill: @barrier-icon;
    marker-clip: false;
  }

  [feature = 'barrier_full-height_turnstile'][zoom >= 25]::barrier {
    marker-file: url('symbols/barrier/full-height_turnstile.svg');
    marker-fill: @barrier-icon;
    marker-clip: false;
  }

  [feature = 'barrier_kissing_gate'][zoom >= 25]::barrier {
  ...
  [feature = 'amenity_bench'][zoom >= 25]::amenity {
  ...
  [feature = 'amenity_waste_basket'][zoom >= 25]::amenity {
  ...
  [feature = 'amenity_waste_disposal'][zoom >= 25]::amenity {
    [access = null],
    [access = 'permissive'],
    [access = 'yes'] {
      marker-file: url('symbols/amenity/waste_disposal.svg');
...
#text-point[zoom >= 25] {
  [feature = 'place_island'][zoom >= 25][way_pixels > 3000],
  [feature = 'place_island'][zoom >= 25],
  [feature = 'place_islet'][zoom >= 25][way_pixels > 3000],
  [feature = 'place_islet'][zoom >= 25] {
    text-name: "[name]";
    text-fill: #000;
  ...
  [feature = 'place_locality'][zoom >= 25] {
    text-name: "[name]";
    text-size: 10;
  ...
  [feature = 'amenity_place_of_worship'][zoom >= 25][way_pixels > 3000],
  [feature = 'amenity_place_of_worship'][zoom >= 25] {
    text-name: "[name]";
    text-size: @standard-font-size;
    text-wrap-width: @standard-wrap-width;
  ...
  [feature = 'power_generator']['generator:source' = 'wind'][location != 'rooftop'][location != 'roof'][zoom >= 25],
  [feature = 'power_generator']['generator:source' = 'wind'][location = null][zoom >= 25],
  [feature = 'power_generator']['generator:source' = 'wind'][zoom >= 25],
  [feature = 'historic_city_gate'][zoom >= 25],
  [feature = 'natural_cave_entrance'][zoom >= 25],
  [feature = 'man_made_mast'][zoom >= 25],
  [feature = 'man_made_tower'][zoom >= 25],
  [feature = 'man_made_storage_tank'][zoom >= 25],
  [feature = 'man_made_silo'][zoom >= 25],
  [feature = 'man_made_communications_tower'][zoom >= 25],
  [feature = 'man_made_telescope']["telescope:type" != 'optical']["telescope:type" != null][zoom >= 25],
  [feature = 'man_made_telescope'][zoom >= 25],
  [feature = 'man_made_water_tower'][zoom >= 25],
  [feature = 'man_made_chimney'][zoom >= 25],
  [feature = 'man_made_crane'][zoom >= 25],
  [feature = 'man_made_waste_water_plant'][zoom >= 25] {
    text-name: "[name]";
    text-size: @standard-font-size;
    text-wrap-width: @standard-wrap-width;
    text-line-spacing: @standard-line-spacing-size;
  ...
  [feature = 'historic_monument'][zoom >= 25],
  [feature = 'historic_fort'][zoom >= 25],
  [feature = 'historic_castle'][zoom >= 25],
  [feature = 'historic_manor'][zoom >= 25] {
    text-name: "[name]";
    text-size: @standard-font-size;
    text-wrap-width: @standard-wrap-width;
  ...
  [feature = 'boundary_protected_area'] {
    [zoom >= 25][way_pixels > 3000][is_building = 'no'],
    [zoom >= 25] {
      text-name: "[name]";
      text-size: @landcover-font-size;
      text-wrap-width: @landcover-wrap-width-size;
  ...
  [feature = 'leisure_pitch'] {
    [zoom >= 25][way_pixels > 3000][is_building = 'no'],
    [zoom >= 25][is_building = 'no'],
    [zoom >= 25][way_pixels > 3000][shop = 'mall'],
    [zoom >= 25][shop = 'mall'] {
      text-name: "[name]";
      text-size: @landcover-font-size;
      text-wrap-width: @landcover-wrap-width-size;
  ...
  [feature = 'amenity_atm'][zoom >= 25],
  [feature = 'amenity_vending_machine'][vending = 'public_transport_tickets'][zoom >= 25] {
    text-name: "[operator]";
    text-size: @standard-font-size;
    text-wrap-width: @standard-wrap-width;
    text-line-spacing: @standard-line-spacing-size;
  ...
  [feature = 'leisure_marina'][zoom >= 25] {
    [zoom >= 25][way_pixels > 3000],
    [zoom >= 25] {
      text-name: "[name]";
      text-size: @landcover-font-size;
  ...
  [feature = 'amenity_fountain'][zoom >= 25] {
    text-name: "[name]";
    text-size: @standard-font-size;
    text-wrap-width: @standard-wrap-width;
    text-line-spacing: @standard-line-spacing-size;
  ...
  [feature = 'amenity_hospital'][zoom >= 25],
  [feature = 'healthcare_hospital'][zoom >= 25] {
    text-name: "[name]";
  ...
  [feature = 'power_plant'][is_building = 'no'][zoom >= 25],
  [feature = 'power_generator'][is_building = 'no']["generator:source" != 'wind'][zoom >= 25],
  [feature = 'power_substation'][is_building = 'no'][zoom >= 25]{
    [way_pixels > 3000],
    [zoom >= 25] {
      text-name: "[name]";
      text-size: @landcover-font-size;
  ...
  [feature = 'natural_scree'][zoom >= 25],
  [feature = 'natural_shingle'][zoom >= 25],
  ...
  [feature = 'tourism_attraction'][zoom >= 25][is_building = 'no'] {
    text-name: "[name]";
    text-size: @standard-font-size;
    text-wrap-width: @standard-wrap-width;
    text-line-spacing: @standard-line-spacing-size;
  ...
  [feature = 'leisure_track'] {
    [zoom >= 25] {
      [zoom >= 25] {
        ...
        [zoom >= 25] { bridgecasing/line-width: 2.5; }
        [zoom >= 25] { bridgecasing/line-width: 5; }
      }
      line-color: @pitch;
      line-join: round;
      line-cap: round;
      line-width: 1;
      [zoom >= 25] { line-width: 2; }
      [zoom >= 25] { line-width: 4; }
    }
  }
